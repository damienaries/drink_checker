<template>
  <div class='overlay fixed z-100 inset-0 h-screen w-screen bg-gray-900 flex items-center justify-center transition-opacity duration-300'>
      <div class="modal-content w-full m-4 h-full md:w-3/4 md:h-3/4 py-4 px-6 bg-white rounded flex flex-col md:flex-row relative overflow-y-scroll">
      <div class="img-placeholder w-full md:w-1/2 mr-4 overflow-hidden">
      ...
      <div class="w-full md:w-1/2 p-4">
        ...
        <div class="mt-4">
          <ul class="border border-black pt-8 pb-4 relative">
      ...
      <button 
        class="md:absolute text-black text-center top-0 right-0 px-6 py-1 rounded m-2 bg-gray-100 hover:bg-gray-200 text-black" 
